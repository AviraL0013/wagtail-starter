...
class SystemMessagesSettings(BaseSiteSetting):
    ...
    footer_newsletter_signup_page = models.ForeignKey(
    'wagtailcore.Page',
    null=True,
    blank=True,
    on_delete=models.SET_NULL,
    related_name='+',
    help_text="Select the Newsletter Signup form page. The footer will submit emails directly to this page.",
)
    ...
    panels = [
        ...
        MultiFieldPanel(
            [
                ...
                FieldPanel("footer_newsletter_signup_page",),
            ],
            heading="Footer",
        ),
    ]
